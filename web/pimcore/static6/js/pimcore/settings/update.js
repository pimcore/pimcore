                ...
                Ext.Ajax.request({
                    ...
                    success: function (response) {
                        ...
                        try {
                            ...
                            this.showErrorMessage("Download fails, see log files in /var/logs or /var/installer/logs for more details.<br /><br />"
                    ...
                    failure: function (response) {
                        ...
                        this.showErrorMessage("Download fails, see log files in /var/logs or /var/installer/logs for more details.<br /><hr />"
                ...
                Ext.Ajax.request({
                    ...
                    success: function (response) {
                        ...
                        try {
                            ...
                            this.showErrorMessage("Install of update fails, see log files in /var/logs or /var/installer/logs for more details.<br />"
                    ...
                    failure: function (response) {
                        ...
                        this.showErrorMessage("Install of update fails, see log files in /var/logs or /var/installer/logs for more details.<br /><hr />"
                        + this.formatError(response) );
                    }.bind(this),
