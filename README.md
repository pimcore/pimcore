...
**Security vulnerabilities:** if you think that you have found a security issue please report it via [Huntr](https://huntr.dev/repos/pimcore/pimcore/) or checkout our [security policy](https://github.com/pimcore/pimcore/security/policy)
