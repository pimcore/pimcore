...
<script type="text/javascript">
    pimcore.settings = {
        ...
        availablePerspectives: <?= \Zend_Json::encode(\Pimcore\Config::getAvailablePerspectives($user)) ?>,
        customviews: <?= \Zend_Json::encode($this->customview_config) ?>,
        disabledPortlets: <?= \Zend_Json::encode((new \Pimcore\Helper\Dashboard($user))->getDisabledPortlets()) ?>
    };
</script>
