...
class ImageThumbnail
{
    ...
    {
        $errorImage = PIMCORE_DOCUMENT_ROOT . '/static/img/filetype-not-supported.png';
        ...
        if (!$this->filesystemPath) {
            ...
            $tempPath = PIMCORE_SYSTEM_TEMP_DIRECTORY . "/" . basename($path);
            ...
            if (!is_file($path)) {
                ...
                if (!is_file($path)) {
                    $converter->saveImage($tempPath, $timeOffset);
