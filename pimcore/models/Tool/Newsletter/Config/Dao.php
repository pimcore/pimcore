...
class Dao extends Model\Dao\JsonTable {
    ...
    public function getByName($id = null) {
        ...
        if(isset($data["id"])) {
            ...
            throw new \Exception("Newsletter with id: " . $this->model->getName() . " does not exist");
        }
    }
    ...
    public function save() {
        ...
        try {
            ...
            $data = [];
            $allowedProperties = ["name","description","document", "class", "objectFilterSQL", "personas",
                "testEmailAddress","googleAnalytics","creationDate","modificationDate"];
