...
pimcore.registerNS("pimcore.asset.permissions");
pimcore.asset.permissions = Class.create({
    ...
    getGrid: function () {
        ...
        this.store = new Ext.data.JsonStore({
            autoDestroy: true,
            root: 'permissions',
            url: "/admin/asset/get-user-permissions",
            autoLoad: false,
            idProperty: "username",
            baseParams:{
                asset: this.asset.id
            },
            fields: ['username', 'list', 'view', 'publish', 'delete', 'rename', 'create', "permissions", "versions", "properties", "settings"]
        });
