...
pimcore.document.tree = Class.create({
    ...
    deleteDocument : function () {
        ...
        Ext.Ajax.request({
            url: "/admin/document/has-dependencies/",
            params: {id: this.id},
    ...
    deleteDocumenFromServer: function () {
            ...
            success: function (response) {
                try {
                    ...
                    if (rdata && rdata.success) {
                        ...
                        pimcore.helpers.showNotification(t("error"), t("error_deleting_document"), "error", t(rdata.message));
                        this.parentNode.reload();
                    }
                } catch (e) {
