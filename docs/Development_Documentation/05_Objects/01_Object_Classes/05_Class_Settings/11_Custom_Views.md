...
For an sample configuration file have a look at the [sample configuration file](https://github.com/pimcore/pimcore/blob/pimcore4/website_demo/config/customviews.example.php) 
