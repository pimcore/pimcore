...
| locks | Store for [Locking functionality](./35_Locking.md) |
...
| targeting_personas | Personas for [targeting](../03_Documents/13_Targeting_and_Personalization/_index.md) |
| targeting_rules | Rules for  [targeting](../03_Documents/13_Targeting_and_Personalization/_index.md) |
