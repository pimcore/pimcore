...
Please refer to the [Example File](https://github.com/pimcore/pimcore/blob/pimcore4/website_demo/config/perspectives.example.php) 
...
In the [Example File](https://github.com/pimcore/pimcore/blob/pimcore4/website_demo/config/perspectives.example.php) you 
