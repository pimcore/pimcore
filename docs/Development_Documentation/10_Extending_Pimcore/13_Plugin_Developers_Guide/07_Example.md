...
|                                                                                                       | Description                                                             |
|-------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| [Plugin Anatomy](!Development_Documentation/Extending_Pimcore/Plugin_Developers_Guide/Plugin_Anatomy) | Detailed extension structure.                                           |
| [Plugin Backend](!Development_Documentation/Extending_Pimcore/Plugin_Developers_Guide/Plugin_Backend) | Learn more about specific elements in your plugin.                      |
| [Plugin Admin UI](!Development_Documentation/Extending_Pimcore/Plugin_Developers_Guide/Plugin_Admin)  | Go there if you would like to know more about Pimcore user interface.   |
...
At this point, if you log into the Pimcore admin then navigate to ![Tools](/Development_Documentation/img/Icon_tools.png)**Tools -> Extensions**  you should be able to see, enable, install and uninstall your new plugin.
Don't forget to activate the extension ![Enable extension](/Development_Documentation/img/Extensions_enable.png)
...
![Extension Example menu item](/Development_Documentation/img/Extensions_new_menu_item.png)
...
![New extension Tab](/Development_Documentation/img/Extensions_new_tab.png)
...
![Final grid](/Development_Documentation/img/Extensions_final_grid.png)