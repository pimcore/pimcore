...
| `admin.login.login.lostpassword` | `Zend_Controller_Action` | (User) `$user` | Can be used to send custom and localized email for password lost (default Pimcore email is automatically disabled if this event is attached) |
