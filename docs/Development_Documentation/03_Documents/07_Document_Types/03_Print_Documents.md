...
They are based on the normal pimcore documents and therefore support everything as documents do - starting from MVC pattern and template creation to document composing within pimcore backend with areas, drag&drop etc. 
