...
* [view-script](https://github.com/pimcore/pimcore/blob/pimcore4/website_example/views/scripts/web2print/default.php#L96)
* [css-file](https://github.com/pimcore/pimcore/blob/pimcore4/pimcore/static6/css/print/print-printermarks.css)
