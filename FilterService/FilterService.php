...
class FilterService {
     ...
     *
     * @param $name
     * @return \OnlineShop\Framework\FilterService\FilterType\AbstractFilterType | string
     */
    ...
    /**
     * @return \OnlineShop\Framework\FilterService\FilterGroupHelper
     * @throws \Exception
     */
    public function getFilterGroupHelper() {
        if(!$this->filterGroupHelper) {
            ...
            if(!class_exists($classname)) {
                ...
                $classname = '\OnlineShop\Framework\FilterService\FilterGroupHelper';
            }
    ...
    /**
     * Adds condition - delegates it to the \OnlineShop\Framework\FilterService\FilterType\AbstractFilterType instance
     *
