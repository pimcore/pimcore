...
<?php if(!$this->success) { ?>
    <form class="form-horizontal" role="form" action="" method="post">
        <div class="row">
            ...
            <div class="col-md-3">
                <h4><?= $this->zf1_translate("Click one of the following logos to auto-fill the form with your data") ?>.</h4>
                <a href="?provider=Facebook"><img style="max-width: 20%;" src="/bundles/websitedemo/img/social-icons/facebook.png"></a>
                <a href="?provider=Twitter"><img style="max-width: 20%;" src="/bundles/websitedemo/img/social-icons/twitter.png"></a>
                <a href="?provider=Google"><img style="max-width: 20%;" src="/bundles/websitedemo/img/social-icons/google.png"></a>
                <a href="?provider=Google"><img style="max-width: 20%;" src="/bundles/websitedemo/img/social-icons/youtube.png"></a>
            </div>
        </div>

        <div class="col-lg-12">
            <div class="form-group">
                <h2><?= $this->zf1_translate("Message"); ?></h2>
