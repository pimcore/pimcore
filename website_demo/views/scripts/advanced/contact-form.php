    ...
    <form class="form-horizontal" role="form" action="" method="post">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a href="?provider=Facebook"><img style="max-width: 20%;" src="/website/static/img/social-icons/facebook.png"></a>
                <a href="?provider=Twitter"><img style="max-width: 20%;" src="/website/static/img/social-icons/twitter.png"></a>
                <a href="?provider=Google"><img style="max-width: 20%;" src="/website/static/img/social-icons/google.png"></a>
                <a href="?provider=Google"><img style="max-width: 20%;" src="/website/static/img/social-icons/youtube.png"></a>
            </div>
        </div>
