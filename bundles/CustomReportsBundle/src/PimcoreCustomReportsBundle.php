...
class PimcoreCustomReportsBundle extends AbstractPimcoreBundle
{
    ...
    public function getJsPaths(): array
    {
        return [
            ...
            '/bundles/pimcorecustomreports/js/pimcore/report/analytics/settings.js',
            '/bundles/pimcorecustomreports/js/pimcore/report/analytics/elementexplorer.js',
            '/bundles/pimcorecustomreports/js/pimcore/report/analytics/elementoverview.js',
            '/bundles/pimcorecustomreports/js/pimcore/report/analytics/siteoverview.js',
            '/bundles/pimcorecustomreports/js/pimcore/report/custom/definitions/analytics.js',
