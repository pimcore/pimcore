                ...
                checkOrder,
                {
                    ...
                    editor: new Ext.form.ComboBox({
                        store: [
                            ...
                            ["date", t("date")],
                            ["boolean", t("bool")],
                            ["@manyToOneRelation:asset", t("Asset relation (has one)")],
                            ["@manyToOneRelation:object", t("Object relation (has one)")],
                            ["@manyToOneRelation:document", t("Document relation (has one)")],
                            ["@advancedManyToManyRelation:asset", t("Asset relation (has many)")],
                            ["@advancedManyToManyRelation:object", t("Object relation (has many)")],
                            ["@advancedManyToManyRelation:document", t("Document relation (has many)")],
                        ],
                        queryMode: 'local',
                        typeAhead: false,
                        editable: false,
