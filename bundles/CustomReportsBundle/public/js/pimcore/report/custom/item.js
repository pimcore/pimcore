                ...
                checkOrder,
                {
                    ...
                    editor: new Ext.form.ComboBox({
                        store: [
                            ...
                            ["@manyToManyRelation:asset", t("Asset relation (has many)")],
                            ["@manyToManyRelation:object", t("Object relation (has many)")],
                            ["@manyToManyRelation:document", t("Document relation (has many)")],
                        ],
                        queryMode: 'local',
                        typeAhead: false,
                        editable: false,
