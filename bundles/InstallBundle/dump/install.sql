...
CREATE TABLE `assets_metadata` (
    ...
    SET
        ascii COLLATE ascii_general_ci NOT NULL DEFAULT '',
        `type` ENUM (
            'input',
            'textarea',
            'asset',
...
CREATE TABLE `assets_image_thumbnail_cache` (
    ...
    SET
        ...
        `filename` varchar(190) CHARACTER
    SET
...
/* this table is created by the installer (see: Pimcore\Bundle\InstallBundle\Installer::setupDatabase) */
...
/* table is created using doctrine:migrations:sync-metadata-storage command */
