 ...
 * @private
 */
pimcore.bundle.googlemarketing.report.analytics.elementoverview = Class.create(pimcore.bundle.customreports.abstract, {
...
if (pimcore.bundle.customreports && pimcore.bundle.customreports.broker) {
    ...
    pimcore.bundle.customreports.broker.addReport(pimcore.bundle.googlemarketing.report.analytics.elementoverview, "analytics");
}
