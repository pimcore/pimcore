        ...
        $rootNode
            ...
            ->children()
                ...
                ->scalarNode('defaultLanguage')
                    ->defaultValue('en')
                ->end()
                ->booleanNode('disableusagestatistics')
                    ->defaultFalse()
                ->end()
                ...
                ->children()
                    ...
                    ->children()
                        ...
                        ->scalarNode('email')
                            ->defaultNull()
                        ->end()
                        ->scalarNode('simpleapikey')
                            ->defaultNull()
                        ->end()
                        ->scalarNode('browserapikey')
                            ->defaultNull()
                        ->end()
                    ->end()
                    ->end()
        ...
        $documentsNode
            ->children()
                ...
                ->arrayNode('error_pages')
                    ...
                    ->end()
                ->end()
                ->booleanNode('createredirectwhenmoved')
                    ->defaultFalse()
                ->end()
                ->scalarNode('allowtrailingslash')
                    ->defaultValue('no')
                ->end()
                ->booleanNode('generatepreview')
                    ->defaultFalse()
                ->end()
                ->integerNode('tree_paging_limit')
                    ->defaultValue(50)
            ...
            ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('lifetime')
                        ->defaultNull()
                    ->end()
                    ->scalarNode('excludePatterns')->end()
                    ->scalarNode('excludeCookie')->end()
            ...
            ->children()
                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('debug')
                            ->children()
                                ->scalarNode('emailaddresses')
                                    ->defaultValue("")
                                ->end()
                            ->end()
                        ->end()
                        ->booleanNode('usespecific')
                        ->end()
                    ->end()
                ->end()
            ->end();
