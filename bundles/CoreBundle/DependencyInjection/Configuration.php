                    ...
                    ->arrayNode('versions')
                        ...
                        ->children()
                            ...
                            ->booleanNode('disable_stack_trace')
                                ...
                                ->defaultFalse()
                            ->end()
                            ->scalarNode('database_connection')->end()
                            ->scalarNode('default_version_storage_adapter')
                                ->defaultValue('db')
                            ->end()
                            ->scalarNode('fallback_version_storage_adapter')
                                ->defaultValue('fs')
                            ->end()
                            ->integerNode('serialized_data_character_threshold')
                                ->defaultValue(8000)
                            ->end()
                            ->integerNode('binary_data_byte_threshold')
                                ->defaultValue(5)
                            ->end()
                        ->end()
                    ->end()
