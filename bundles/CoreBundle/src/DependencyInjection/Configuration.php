                                                    ...
                                                    ->children()
                                                        ...
                                                        ->arrayNode('notifyUsers')
                                                            ->prototype('scalar')
                                                                ->cannotBeEmpty()
                                                            ->end()
                                                            ->info('Send an email notification to a list of users (user names) when the global action gets applied')
                                                        ->end()
                                                        ->arrayNode('notifyRoles')
                                                            ->prototype('scalar')
                                                                ->cannotBeEmpty()
                                                            ->end()
                                                            ->info('Send an email notification to a list of user roles (role names) when the global action gets applied')
                                                        ->end()
                                                        ->arrayNode('channelType')
                                                            ->requiresAtLeastOneElement()
                                                            ->enumPrototype()
