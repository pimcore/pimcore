...
class ExtJSCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        if ($mode != "editmode") {
            throw new \Exception("currently only editmode is supported");
        }

        if (!$src) {
            $src = 'dev/pimcore/pimcore/bundles/AdminBundle/Resources/public/js/ext-js/pimcoreEditmode.json';
        }

        if (!$dest) {
            $dest = 'dev/pimcore/pimcore/bundles/AdminBundle/Resources/public/js/ext-js/ext-editmode.js';
        }
