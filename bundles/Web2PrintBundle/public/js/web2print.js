...
pimcore.settings.web2print = Class.create({
    ...
    getData: function () {
        Ext.Ajax.request({
            url: Routing.generate('pimcore_web2print_settings_getweb2print'),
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            ...
            this.panel.on("destroy", function () {
                pimcore.globalmanager.remove("web2print_web2print");
            }.bind(this));
    ...
    save: function () {
        ...
        Ext.Ajax.request({
            url: Routing.generate('pimcore_web2print_settings_setweb2print'),
            method: "PUT",
            params: {
    ...
    test: function () {
        window.open(Routing.generate('pimcore_web2print_settings_testweb2print'), "_blank");
    }
});
