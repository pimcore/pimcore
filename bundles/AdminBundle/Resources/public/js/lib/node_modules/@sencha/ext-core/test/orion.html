...
<head>
    ...
    <!--
        Core package does not compile CSS bootstrap so we have to include stylesheet explicitly
    -->
    <link rel="stylesheet" type="text/css" href="../../../build/classic/theme-classic/resources/theme-classic-all.css">
    ...
    <!--
        ...
        The list of scripts below should include:
            - Test scaffold and necessary 3rd party libs (Jasmine, JSON2, etc)
    ...
    <script type="text/javascript" src="../../../test/lib/jazzman-orion.js"></script>
    ...
    <script type="text/javascript" src="../../../packages/core/test/resources/helpers.js"></script>
    <script type="text/javascript" src="../../../test/shared/pre-init.js"></script>
    <script type="text/javascript" src="../../../test/shared/init.js"></script>
</head>
