...
Ext.define('Ext.sparkline.CanvasCanvas', {
        ...
        contextOverrides: (function() {
            ...
            return {
                ...
                arc: function(x, y, radius, startAngle, endAngle, counterclockwise) {
                    ...
                    this.$arc(x * ratio, y * ratio, radius * ratio, startAngle, endAngle,
                              counterclockwise);
                },
    ...
    _drawRect: function(shapeid, x, y, width, height, lineColor, fillColor) {
        return this._drawShape(shapeid, [[x, y], [x + width, y], [x + width, y + height],
                                         [x, y + height], [x, y]], lineColor, fillColor);
    },
