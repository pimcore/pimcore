...
pimcore.registerNS("pimcore.report.webmaintools.settings");
pimcore.report.webmaintools.settings = Class.create({
...
pimcore.report.settings.broker.push("pimcore.report.webmaintools.settings");
