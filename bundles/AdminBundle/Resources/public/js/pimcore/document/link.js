            ...
            pathField.on("render", function (el) {
                var dd = new Ext.dd.DropZone(el.getEl().dom.parentNode.parentNode, {
                    ...
                    onNodeOver: function (target, dd, e, data) {
                        if (data.records.length === 1 && (data.records[0].data.elementType === "document" || data.records[0].data.elementType === "asset") && data.records[0].data.type !== "folder") {
                    ...
                    onNodeDrop: function (target, dd, e, data) {
                        ...
                        if (data.type !== "folder" && (data.elementType === "document" || data.elementType === "asset")) {
