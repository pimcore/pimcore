...
class IndexController extends AdminController implements EventedControllerInterface
{
    ...
    /**
     * @Route("/index/pimcoreEditmodeScriptsMinified.js", name="pimcore_admin_pimcore_editmode_scripts_minified", methods={"GET"})
     *
     * @throws \Exception
     */
    public function pimcoreEditmodeScriptsMinfiedAction(Request $request, Packages $packages, RouterInterface $router) {
        $scriptContents = "";
...
//                    $includeContents = $minify->minify();
    ...
    /**
     * @Route("/index/pimcoreEditmodeScripts", name="pimcore_admin_pimcore_editmode_scripts", methods={"GET"})
     *
     * @throws \Exception
     */
