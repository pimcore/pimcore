        ...
        if ($ids) {
            ...
            if ($groupIdList) {
                ...
                foreach ($keyList as $keyData) {
                    ...
                    if ($definition instanceof DataObject\ClassDefinition\Data\LayoutDefinitionEnrichmentInterface || method_exists($definition, 'enrichLayoutDefinition')) {
                        if (!$definition instanceof DataObject\ClassDefinition\Data\LayoutDefinitionEnrichmentInterface) {
                            trigger_deprecation('pimcore/pimcore', '10.1', 'Usage of method_exists is deprecated since version 10.1 and will be removed in Pimcore 11.' .
