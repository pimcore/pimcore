...
class DataObjectDataExtractor extends AbstractElementDataExtractor
{
     ...
     * @throws \Exception
     */
    private function extractRawAttributeSet(TranslationItem $translationItem, string $sourceLanguage, array $targetLanguages, array|null $exportAttributes, bool $inherited): AttributeSet
    {
