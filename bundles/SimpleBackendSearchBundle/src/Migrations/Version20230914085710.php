...
final class Version20230914085710 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE `search_backend_data` MODIFY `fullpath` varchar(765) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL');
    ...
    {
        $this->addSql('ALTER TABLE `search_backend_data` MODIFY `fullpath` varchar(765) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL');
