...
[Pimcore Bundle](../10_Extending_Pimcore/04_Pimcore_Bundle_Developers_Guide/01_Pimcore_Bundles/README.md) or from somewhere else.

## Pimcore Bundles

Just add the [`PimcoreBundleAdminClassicInterface`](https://github.com/pimcore/pimcore/blob/2026.x/lib/Extension/Bundle/PimcoreBundleAdminClassicInterface.php) to your bundle class.
...
In order to implement all four methods prescribed by the interface you can use the [`BundleAdminClassicTrait`](https://github.com/pimcore/pimcore/blob/2026.x/lib/Extension/Bundle/Traits/BundleAdminClassicTrait.php).
...
You can add additional paths to load by handling the events defined on [`BundleManagerEvents`](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/BundleManagerEvents.php).
For example, to load the JS file when loading the admin UI, implement an event listener like the following (please see
[Events](../10_Extending_Pimcore/01_Events/README.md) for details on how to implement and register event
listeners): 
