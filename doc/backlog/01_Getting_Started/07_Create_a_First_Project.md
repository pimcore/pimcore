...
For details concerning editables (like `pimcore_input`, `pimcore_block`, ...) see [Editables](../../01_Documents/01_Templates/03_Editables/README.md). 
...
[Thumbnails](../../02_Assets/01_Working_with_Thumbnails/01_Image_Thumbnails.md) for different output
channels are created directly
[within Pimcore](../../02_Assets/01_Working_with_Thumbnails/01_Image_Thumbnails.md) using custom configurations.
...
More specific backgrounds and insights can be found in the [Objects section](../../03_Objects/README.md)
...
alternative for that would be the [Renderlet](../../01_Documents/01_Templates/03_Editables/28_Renderlet.md) editable.
Click [here](../../01_Documents/01_Templates/03_Editables/README.md) for a full list of available editables in Pimcore.
...
To show the product image in the view, we need to add a thumbnail configuration first. Using [thumbnail configurations](../../02_Assets/01_Working_with_Thumbnails/01_Image_Thumbnails.md),
