...
- [PimcoreApplicationLoggerBundle](../../../09_Development_Tools/02_Logging/01_Application_Logger.md)
- [PimcoreCustomReportsBundle](../../../06_Reporting/01_Custom_Reports.md)
- [PimcoreGlossaryBundle](../../21_Glossary.md)
- PimcoreSeoBundle (for SEO-related topics: [Robots.txt](../../../01_Documents/10_Robots_txt.md), [Sitemaps](../../../01_Documents/11_Sitemaps.md) and [Redirects](../../../01_Documents/05_Routing_and_URLs/02_Redirects.md))
- PimcoreSimpleBackendSearchBundle (for default search functionality in Backend UI interface)
- [PimcoreStaticRoutesBundle](../../02_MVC_Custom_Routes.md)
- [PimcoreQuillBundle](https://github.com/pimcore/quill-bundle/blob/1.x/README.md) (for default WYSIWYG editor)
- [PimcoreUuidBundle](../../../09_Development_Tools/06_UUID_Support.md)
...
The feature for displaying a [preview of documents](../../../02_Assets/01_Working_with_Thumbnails/03_Asset_Document_Thumbnails.md) directly in Pimcore is optional. To use it, you must install either [Gotenberg](../../23_Installation_and_Upgrade/03_System_Setup_and_Hosting/06_Additional_Tools_Installation.md#gotenberg) or [LibreOffice](../../23_Installation_and_Upgrade/03_System_Setup_and_Hosting/06_Additional_Tools_Installation.md#libreoffice-pdftotext-inkscape-) according to your preference.
