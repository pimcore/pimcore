...
[Pimcore Bundles](../10_Extending_Pimcore/04_Pimcore_Bundle_Developers_Guide/01_Pimcore_Bundles/README.md). 
...
Pimcore supports i18n for UI extensions. First see the [i18n section for bundles](../10_Extending_Pimcore/04_Pimcore_Bundle_Developers_Guide/README.md) how to prepare the data
server-side. 
