...
[here](../../01_Documents/README.md)) and Twig variables. 

To send an email you just create an `Email Document` in the Pimcore Backend UI, define the subject, 
...
## Usage Example
Lets assume that we have created an `Email Document` in the Pimcore Backend UI (`/email/myemaildocument`) 
