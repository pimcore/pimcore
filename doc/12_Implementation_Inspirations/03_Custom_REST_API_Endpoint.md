...
However, a common use case for applications built with Pimcore is integrating with external systems,
...
This can be achieved by [overriding a model](../10_Extending_Pimcore/03_Custom_Extension_Guides/08_Overriding_Models.md)
