...
description: Reference for all Pimcore Twig extension functions, filters, tags, and tests available in templates.
keywords:
    - twig
    - template functions
    - template helpers
...
Following an overview of some [Twig Extensions](https://twig.symfony.com/doc/3.x/#reference):
- `render`
- `render_esi`
- `controller`
- `asset`
...
All Twig extension functions are described below in detail,
the following tables give just a short overview of all available extensions.
...
Used to interact with navigations. See [Navigation](../../06_Navigation.md) for details. Simplified example:
...
See [PimcoreObjectExtension](https://github.com/pimcore/pimcore/blob/2026.x/lib/Twig/Extension/PimcoreObjectExtension.php)
...
[Block](../03_Editables/06_Block.md) editable,
