---
title: Editables
description: Content editing placeholders in document templates that render as input widgets in Pimcore Studio.
---

# Editables

The editables are placeholders in the templates, which are displayed as input widgets in Pimcore Studio (so called editmode) and output the content in frontend mode.
