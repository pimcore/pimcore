---
title: Input
description: Single-line unformatted text input for headlines, paragraphs, and short text values.
---
...
![Input preview in the backend](../../../img/input_backend_preview.png)
