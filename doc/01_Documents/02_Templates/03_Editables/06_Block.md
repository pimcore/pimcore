---
title: Block
description: Repeatable loop component for creating structured content like link lists or image galleries.
---
...
<div>
    {% blockiterate %}
        ...
        Add additional class 'my-additional-class' to editmode-div
        {% do _block.blockEnd() %}
    {% endblockiterate %}
</div>
{% endpimcoremanualblock %}
