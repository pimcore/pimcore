...
description: Create a single reference to a document, asset, or object element in Pimcore.
---
...
After, the view in Pimcore Studio changes like in the picture:

![Relation editable preview in Pimcore Studio](../../../img/href_backend_preview.png)
