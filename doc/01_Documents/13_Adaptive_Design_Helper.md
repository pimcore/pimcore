---
title: Adaptive Design Helper
description: Using the DeviceDetector helper to implement adaptive design patterns in Pimcore controllers and templates.
---

# Adaptive Design Helper

The DeviceDetector helper makes it easy to implement adaptive design in Pimcore.
Adaptive design serves different content or templates based on the detected device type
(phone, tablet, desktop), as opposed to responsive design which uses CSS to adapt a single template.

In Twig templates, use the [`pimcore_device()` function](./02_Templates/02_Twig_Extensions/README.md#pimcore_device)
