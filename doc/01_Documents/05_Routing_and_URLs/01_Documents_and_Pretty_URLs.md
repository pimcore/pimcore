...
## Document Path
 Every document has a path (in the document tree) that directly represents the address in the browser 
  ...
  See [Documents documentation](../README.md) for more details for setting of Documents. 
...
## Creating URLs to Documents
The default route is also responsible to assemble the URLs for documents.
