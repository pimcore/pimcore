...
Using a main document doesn't change anything in the PHP API. If you load a document that has a related main document,
the values returned by it will be replaced by values from the main document (unless values are overwritten).
