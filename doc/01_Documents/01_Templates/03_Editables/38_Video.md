...
Local asset videos support the automatic generation and transcoding of videos using [Video Thumbnails](../../../02_Assets/01_Working_with_Thumbnails/02_Video_Thumbnails.md). 
...
| `thumbnail`             | string         | Name of the video-thumbnail (required when using automatic-transcoding of videos) see: [Video Thumbnails](../../../02_Assets/01_Working_with_Thumbnails/02_Video_Thumbnails.md)                                          |
...
Read more about [Video Thumbnails](../../../02_Assets/01_Working_with_Thumbnails/02_Video_Thumbnails.md).
