...
but [Symfony-style locations](https://symfony.com/doc/current/best_practices.html#use-the-default-directory-structure) also work (both controller as well as action without their suffix).  
...
You can take a look at the [implementations](https://github.com/pimcore/pimcore/tree/2026.x/lib/Twig)
...
See [Template Extensions](./02_Twig_Extensions/README.md) for details.


#### Templating extensions

The following extensions can directly be used on Twig. See [Template Extensions](./02_Twig_Extensions/README.md) for a 
...
As Twig does not provide a `while` control structure which is needed to iterate a [Block](./03_Editables/06_Block.md)
...
* [Template inheritance and Layouts](./01_Template_Inheritance_and_Layouts.md) - Use layouts and template inheritance to define everything that repeats on a page. 
* [Template Extensions](./02_Twig_Extensions/README.md) - Use twig extensions for things like includes, translations, cache, glossary, etc.
* [Thumbnails](./04_Pimcore_Thumbnails.md) - Learn how to include images into templates with using Thumbnails.
