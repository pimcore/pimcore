...
| `youtube`              | array          | Parameters for youtube integration. Possible parameters: [https://developers.google.com/youtube/player_parameters](https://developers.google.com/youtube/player_parameters) and `referrerpolicy` (default: `strict-origin-when-cross-origin`) - only for type **_youtube_** |      |
