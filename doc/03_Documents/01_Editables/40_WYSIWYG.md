...
> Note: By default, HTML sanitizer truncates content cat 20.000 characters. To change that, see [symfony documentation](https://symfony.com/doc/current/html_sanitizer.html#max-input-length). 
