...
Admin translations underlay the same case sensitivity logic as [shared translations](./02_Shared_Translations.md#translations-case-sensitivity).
...
If you haven't configured anything different, this is `%kernel.project_dir%/translations`.
