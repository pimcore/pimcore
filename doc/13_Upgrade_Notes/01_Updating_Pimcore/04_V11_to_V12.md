...
TinyMCE is available exclusively to Pimcore Professional and Enterprise editions. 
...
If you're using Pimcore Community Edition, there's still the possibility to use a [legacy and unmaintained version of TinyMCE](https://github.com/pimcore/tinymce-bundle).

#### Enable Quill (recommended for Community Edition)
Please check the bundle [readme](https://github.com/pimcore/quill-bundle/blob/1.x/README.md) for installation instructions.
To migrate from TinyMCE to Quill please check the following [link](https://github.com/pimcore/quill-bundle/blob/1.x/doc/03_Migration_to_Quill.md)
...
- From now on, Pimcore requires a product registration and container build will fail if the product key is not valid.
  ...
  [Product Registration](https://github.com/pimcore/platform-version/blob/2026.x/doc/03_Getting_Started/02_Product_Registration.md).
