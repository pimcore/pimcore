...
- Carefully read our [Upgrade Notes](../README.md) before any update. 
...
- (optional) Run [migrations of your app or bundles](../../09_Development_Tools/08_Migrations.md)

## Upgrading from earlier Versions
- [Upgrade from Version 6 to Version 10](./01_V6_to_V10.md)
- [Preparing for Version 11](./02_Preparing_for_V11.md)
- [Upgrade from Version 10 to Version 11](./03_V10_to_V11.md)
- [Upgrade from Version 11 to Version 12](./04_V11_to_V12.md)
- [Upgrade from Version 12 to Version 13](./05_V12_to_V13.md)
