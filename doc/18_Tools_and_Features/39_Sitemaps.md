...
* [`UrlGenerator`](https://github.com/pimcore/pimcore/blob/12.x/bundles/SeoBundle/src/Sitemap/UrlGenerator.php)
...
generator to query for this information). For example the [PropertiesFilter](https://github.com/pimcore/pimcore/blob/12.x/bundles/SeoBundle/src/Sitemap/Element/Filter/PropertiesFilter.php)
excludes elements with a property `sitemaps_exclude`. A **processor** can enhance an entry before it is added to the container. For example, the [ModificationDateProcessor](https://github.com/pimcore/pimcore/blob/12.x/bundles/SeoBundle/src/Sitemap/Element/Processor/ModificationDateProcessor.php)
...
Pimcore ships a default generator for documents implemented in [`DocumentTreeGenerator`](https://github.com/pimcore/pimcore/blob/12.x/bundles/SeoBundle/src/Sitemap/Document/DocumentTreeGenerator.php).
...
[sitemaps.yaml in the CoreBundle](https://github.com/pimcore/pimcore/blob/12.x/bundles/CoreBundle/config/sitemaps.yaml).
...
To generate absolute URLs, Pimcore defines an [url generator](https://github.com/pimcore/pimcore/blob/12.x/bundles/SeoBundle/src/Sitemap/UrlGenerator.php) which, given a path, takes care of creating an absolute URL
