...
- [Request] Removed deprecated getMainRequest() in favor of getMainRequest().
...
- Removed `\Pimcore\Google\Webmaintools`, use `\Pimcore\Config::getReportConfig()->get('webmaintools'')` instead.
