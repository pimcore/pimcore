...
TinyMCE is available exclusively available to Pimcore Professional & Enterprise editions. 
...
Please check the bundle [readme](https://github.com/pimcore/quill-bundle/blob/2026.x/README.md) for installation instructions.
To migrate from TinyMCE to Quill please check the following [link](https://github.com/pimcore/quill-bundle/blob/2026.x/doc/01_Migration_to_Quill.md)
