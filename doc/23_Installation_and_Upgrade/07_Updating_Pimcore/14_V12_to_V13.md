...
-   The folder structure for email logs is changed to YYYY/MM/DD/\<log filename\>. Please execute the command `pimcore:migrate:mail-logs-folder-structure` or move the files manually.
