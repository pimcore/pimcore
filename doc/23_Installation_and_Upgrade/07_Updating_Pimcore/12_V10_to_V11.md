...
If you use the Newsletter functionality please make sure to add the `pimcore/compatibility-bridge-v10` to your composer.json  
```bash
composer require pimcore/compatibility-bridge-v10
```
