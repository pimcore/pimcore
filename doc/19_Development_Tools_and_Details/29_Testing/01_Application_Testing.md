...
which is defined as `PIMCORE_TEST_DB_DSN` environment variable by default (see [config/packages/test/config.yaml](https://github.com/pimcore/pimcore/blob/12.x/.github/ci/files/config/packages/test/config.yaml#L19)).
