...
not located in `config/`, but in the [PimcoreCoreBundle](https://github.com/pimcore/pimcore/tree/12.x/bundles/CoreBundle/config/pimcore).
...
defined in [`lib/Bootstrap.php`](https://github.com/pimcore/pimcore/blob/12.x/lib/Bootstrap.php).
...
Please see [`lib/Bootstrap.php`](https://github.com/pimcore/pimcore/blob/12.x/lib/Bootstrap.php)
