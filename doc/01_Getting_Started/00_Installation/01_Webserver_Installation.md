...
After the installer has finished and your [server is configured](../../23_Installation_and_Upgrade/01_System_Requirements.md), you can open the admin interface: `https://your-host.com/admin`
