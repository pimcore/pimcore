...
- `\Pimcore\Bundle\EcommerceFrameworkBundle\FilterService\Helper::setupProductList()` has been deprecated and will be removed in Pimcore 7. Use `\Pimcore\Bundle\EcommerceFrameworkBundle\FilterService\Helper::initProductList` instead.
