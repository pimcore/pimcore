...
- The object query table will now consider the fallback language. If you want to keep the old behavior set `pimcore:objects:ignoreLocalizedQueryFallback` in your configuration.  
- Removed QR Codes.
...
## 6.4.0
- Deprecated the REST Webservice API. The API will be removed in Pimcore 10, use the [Pimcore Data Hub](https://github.com/pimcore/data-hub) instead.
