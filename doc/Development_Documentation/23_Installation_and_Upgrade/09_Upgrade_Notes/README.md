...
- [Permissions] Permission for DataObjects Classes has been structured in a more granular way to have more control. Field-Collections, Objects Bricks, the Classification Store and Quantity Value Units now have their own permission. [Dataobject Permissions](https://github.com/pimcore/pimcore/pull/13605)
