...
- Pimcore now adds a CSP header to all /admin requests: https://github.com/pimcore/pimcore/pull/11447/files. You might have to adopt your script tags ([see docs](https://github.com/pimcore/pimcore/blob/10.x/doc/Development_Documentation/26_Best_Practice/75_Security_Concept.md)) or exclude the routes (https://github.com/pimcore/pimcore/pull/11875) if you have any custom implementations.
