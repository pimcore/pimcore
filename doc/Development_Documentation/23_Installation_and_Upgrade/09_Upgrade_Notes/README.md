...
- [Targeting] Targeting is now using the opt-in approach. So, it will not be enabled by default. Please set the cookie `pimcore_targeting_enabled=1` to enable it.
