...
- If a custom data-type extends from a core data-type it must compatible to the new interfaces (CustomResourcePersistingInterface, QueryResourcePersistenceAwareInterface and ResourcePersistenceAwareInterface)
