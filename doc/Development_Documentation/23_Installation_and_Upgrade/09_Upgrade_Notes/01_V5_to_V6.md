...
Database settings moved to symfony core in system settings migration from system.php to system.yml [#3268](https://github.com/pimcore/pimcore/issues/3268). So, it is important to create database.yml manually before running update. 
