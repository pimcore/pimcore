...
- Methods `getChilds()` and `setChilds()` was removed from Assets, Documents and Data Objects
...
Pimcore\Model\User\UserRole\Folder::setHasChilds()
Pimcore\Model\Element\AbstractElement::hasNoChilds()
