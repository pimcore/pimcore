...
> docker-compose files in our [skeleton](https://github.com/pimcore/skeleton/blob/10.x/docker-compose.yaml) 
> and [demo application](https://github.com/pimcore/demo/blob/10.x/docker-compose.yaml).  
