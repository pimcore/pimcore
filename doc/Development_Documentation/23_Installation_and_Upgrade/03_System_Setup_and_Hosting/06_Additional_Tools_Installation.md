...
Since sqip requires [primitive](https://github.com/fogleman/primitive) - which is a written in Go - you need that [set-up](http://internetpartner.info/en/tutorials/ubuntu/104-how-to-install-go-from-ubuntu-repositories-and-set-gopath.html) also.
