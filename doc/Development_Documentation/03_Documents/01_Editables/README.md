...
| [1:1 Relation (Href)](./12_Href.md)                   | Href provides possibility to create a reference to any other element in Pimcore (document, asset, object).                                                                                                                      |
| [1:n Relation (Multihref)](./20_Multihref.md)      | Multihref provides possibility to edit multiple references to other elements in Pimcore (documents, assets. object).                                                                                                                  |
