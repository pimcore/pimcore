...
| `height`                | integer/string | Height of the video in pixel or in percent (Default: 300)                                                                                                                                                             |
...
| `width`                 | integer/string | Width of the video in pixel or in percent (Default: 100%)                                                                                                                                                             |
