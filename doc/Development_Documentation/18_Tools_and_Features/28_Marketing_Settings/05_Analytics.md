...
* the definition of available blocks in the [Tracker implementation](https://github.com/pimcore/pimcore/blob/10.5/lib/Analytics/Google/Tracker.php#L66)
* the [templates](https://github.com/pimcore/pimcore/blob/10.5/bundles/CoreBundle/Resources/views/Analytics/Tracking/Google/Analytics)
