...
Here you can find an example how to [create](https://github.com/pimcore/demo-basicsrc/AppBundle/Templating/Helper/LanguageSwitcher.php)
and [register](https://github.com/pimcore/demo-basicsrc/AppBundle/Resources/config/services.yml#L41)
