...
Have a look at the `Symfony\Console` [documentation](http://symfony.com/doc/5.2/console.html) 
...
and a helper for the [Symfony VarDumper Component](http://symfony.com/doc/5.2/components/var_dumper/index.html) 
...
Better `var_dump` through [`VarDumper`](http://symfony.com/doc/5.2/components/var_dumper/introduction.html). 
