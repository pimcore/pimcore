...
For a sample configuration file have a look at the [sample configuration file](https://github.com/pimcore/skeleton/blob/10.2/config/pimcore/customviews.example.php) 
