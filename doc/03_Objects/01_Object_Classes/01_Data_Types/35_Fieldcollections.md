...
description: "Predefined sets of data and layout fields that can be added to objects in arbitrary amounts."
---
...
Nevertheless, you can use inheritance for field collections for data maintenance by [overriding the class](../../../10_Extending_Pimcore/03_Custom_Extension_Guides/08_Overriding_Models.md) which contains the field collection field and adding a custom getter method to this overriding class:
```php
...
There could also be some UI quirks in Pimcore Studio.
