...
> if you want to explicitly fix that.
...
To get the inherited values via code, you have to use the getter methods of the attributes. By accessing 
...
to use the custom classes instead of the generated object classes. This can be done by using [model overrides](../../../../10_Extending_Pimcore/03_Custom_Extension_Guides/08_Overriding_Models.md).
