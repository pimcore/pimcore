...
With bundles, it is also possible to add individual layout types for Pimcore Objects. 
...
1) Create a PHP class for server-side implementation:
   ...
   [github](https://github.com/pimcore/pimcore/tree/2026.x/models/DataObject/ClassDefinition/Layout). 
