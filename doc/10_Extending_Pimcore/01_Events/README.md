...
The most common use-case for events is using them in a [bundle/extension](../../backlog/06_Event_Listener_UI.md), but 
...
so you can also subscribe to all Symfony core events and events triggered by arbitrary Symfony bundles. 
...
- [Assets](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/AssetEvents.php)
- [Documents](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/DocumentEvents.php)
- [Data Objects](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/DataObjectEvents.php)
- [Versions](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/VersionEvents.php)
- [Data Object Class Definition](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/DataObjectClassDefinitionEvents.php)
- [Object Brick Definition](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/ObjectbrickDefinitionEvents.php)
- [Data Object Classification Store](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/DataObjectClassificationStoreEvents.php)
- [Data Object Custom Layouts](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/DataObjectCustomLayoutEvents.php)
- [Data Object Import](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/Model/DataObjectImportEvent.php)
- [Data Object Quantity Value Unit](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/DataObjectQuantityValueEvents.php)
- [Users / Roles](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/UserRoleEvents.php)
- [Workflows](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/WorkflowEvents.php)
- [Elements](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/ElementEvents.php)
- [Mail](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/MailEvents.php)
- [Notifications](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/NotificationEvents.php)
- [Redirect](https://github.com/pimcore/pimcore/blob/2026.x/bundles/SeoBundle/src/Event/RedirectEvents.php)
- [Admin](https://github.com/pimcore/admin-ui-classic-bundle/blob/1.x/src/Event/AdminEvents.php)
- [Frontend](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/FrontendEvents.php)
- [Cache](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/CoreCacheEvents.php)
- [Full-Page Cache](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/FullPageCacheEvents.php)
- [Search](https://github.com/pimcore/pimcore/blob/2026.x/bundles/SimpleBackendSearchBundle/src/Event/SearchBackendEvents.php)
- [System](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/SystemEvents.php)
- [Tags](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/TagEvents.php)
...
- [Tests](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/TestEvents.php)
- [Translation](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/TranslationEvents.php)
- [Bundle Manager for injecting js/css files to Pimcore backend or editmode](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/BundleManagerEvents.php)
...
The [AssetEvents::RESOLVE_UPLOAD_TARGET](https://github.com/pimcore/pimcore/blob/2026.x/lib/Event/AssetEvents.php) event
...
The contextual info provided is the same as described [here](../../03_Objects/01_Object_Classes/01_Data_Types/10_Calculated_Value_Type.md):
