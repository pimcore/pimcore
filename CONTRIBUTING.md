...
* Select the right branch. `main`(`11.x`) for features and improvements or latest maintenance branch for bug fixes (`10.6`)
* Code! Follow the coding standards defined [here](https://github.com/pimcore/pimcore/blob/11.x/.php-cs-fixer.dist.php) and [here](https://github.com/pimcore/pimcore/blob/11.x/doc/Development_Documentation/19_Development_Tools_and_Details/29_Testing/02_Core_Tests.md#perform-phpstan-analysis)
