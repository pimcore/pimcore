...
* Select the right branch. Choose Pimcore (`10.6`) for Pimcore 10 bugfixes. (`11.1`) for features and improvements for Pimcore 11 and (`11.0`) for Pimcore 11 bugfixes.
