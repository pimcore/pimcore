...
@trigger_error(sprintf('Class "%s" is deprecated since v6.7 and will be removed in 7. Use "%s" instead.', TagLoaderInterface::class, EditableLoaderInterface::class), E_USER_DEPRECATED);
