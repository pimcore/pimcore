...
class DefinitionPathResolver implements DefinitionPathResolverInterface
{
    ...
    public function resolvePath(string $name)
    {
        return $this->definitionDirectory.'/definition_'.$name.'.php';
    }
}
