    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?= $this->url(array('action' => 'genearte', 'controller'=>'voucher', 'id'=>$this->id)) ?>" class="btn btn-primary js-loading" data-msg="<?=$this->ts('plugin_onlineshop_voucherservice_modal_assign-infotext')?>"><?=$this->ts('plugin_onlineshop_voucherservice_modal_assign-submit')?></a>
