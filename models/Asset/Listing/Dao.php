...
class Dao extends Model\Listing\Dao\AbstractDao
{
    ...
    public function load(): array
    {
        ...
        $assetsData = $this->db->fetchAllAssociative((string) $queryBuilder, $queryBuilder->getParameters(), $queryBuilder->getParameterTypes());
    ...
    public function loadIdList(): array
    {
        ...
        $assetIds = $this->db->fetchFirstColumn((string) $queryBuilder, $queryBuilder->getParameters(), $queryBuilder->getParameterTypes());
