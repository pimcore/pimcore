...
class OnlineShop_Framework_Impl_CartItem_Resource extends Pimcore_Model_Resource_Abstract {
    ...
    protected $fieldsToSave = array("cartId", "productId", "count", "itemKey", "parentItemKey");
