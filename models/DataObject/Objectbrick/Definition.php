 ...
 * @method string getTableName(DataObject\ClassDefinitionInterface $class, $query)
 * @method void createUpdateTable(DataObject\ClassDefinitionInterface $class)
 * @method string getLocalizedTableName(DataObject\ClassDefinitionInterface $class, $query)
 */
