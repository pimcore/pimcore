...
@trigger_error(sprintf('Class "%s" is deprecated since v6.8 and will be removed in Pimcore 10. Use "%s" instead.', Textarea::class, EditableTextarea::class), E_USER_DEPRECATED);
