...
@trigger_error(sprintf('Class "%s" is deprecated since v6.8 and will be removed in 7. Use "%s" instead.', Renderlet::class, EditableRenderlet::class), E_USER_DEPRECATED);
