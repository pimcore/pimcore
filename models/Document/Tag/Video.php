...
class Video extends Model\Document\Tag
{
    ...
    public function getProgressCode($thumbnail = null)
    {
        ...
        <div id="pimcore_video_' . $this->getName() . '" class="pimcore_tag_video pimcore_editable_video">
            <style type="text/css">
                #' . $uid . ' .pimcore_tag_video_progress_status .pimcore_editable_video_progress_status {
    ...
    public function getEmptyCode()
    {
        ...
        return '<div id="pimcore_video_' . $this->getName() . '" class="pimcore_tag_video pimcore_editable_video"><div class="pimcore_tag_video_empty pimcore_editable_video_empty" id="' . $uid . '" style="width: ' . $this->getWidth() . 'px; height: ' . $this->getHeight() . 'px;"></div></div>';
    }
