...
class GridConfig extends AbstractModel
{
    ...
    public function delete()
    {
        ...
        $db = Db::get();
        $db->executeQuery('DELETE from gridconfig_favourites where gridConfigId = ' . $db->quote($this->getId()));
        $db->executeQuery('DELETE from gridconfig_shares where gridConfigId = ' . $db->quote($this->getId()));
    }
