...
if (!TmpStore::get($tmpStoreId)) {
    ...
    echo 'Please see <a href="https://pimcore.com/docs/5.0.x/Development_Documentation/Installation_and_Upgrade/Upgrade_Notes/Within_V5.html#page_Pimcore-5-1" target="_blank">the upgrade notes</a> for details<br/>';
    echo 'and restart the update process to continue.';
    exit;
}
