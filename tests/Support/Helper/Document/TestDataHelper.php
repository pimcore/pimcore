...
{
    public function assertAreablock(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
    ...
    public function assertCheckbox(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
    ...
    public function assertDate(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
        /** @var Date $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertEmbed(Page $page, string $field, int $seed = 1)
    {
        /** @var Embed $editable */
    ...
    public function assertImage(PageSnippet $pagesnippet, string $field, int $seed = 1, array $params = [])
    {
        /** @var Image $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertInput(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
        /** @var Input $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertLink(PageSnippet $pagesnippet, string $field, int $seed = 1, $params = [])
    {
        /** @var Link $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertMultiselect(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
        /** @var Select $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertNumeric(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
    ...
    public function assertPdf(PageSnippet $pagesnippet, string $field, int $seed = 1, array $params = [])
    {
        /** @var Pdf $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertRelation(PageSnippet $pagesnippet, string $field, int $seed = 1, $params = [])
    {
    ...
    public function assertRelations(PageSnippet $pagesnippet, string $field, int $seed = 1, $params = [])
    {
    ...
    public function assertScheduledblock(Page $page, string $field, int $seed = 1)
    {
    ...
    public function assertSelect(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
        /** @var Select $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertTable(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
        /** @var Table $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertVideo(PageSnippet $pagesnippet, string $field, int $seed = 1, array $params = [])
    {
        /** @var Video $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function assertWysiwyg(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
    ...
    public function assertTextarea(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
    ...
    public function assertBlock(PageSnippet $pagesnippet, string $field, int $seed = 1)
    {
        /** @var Block $editable */
        $editable = $pagesnippet->getEditable($field);
    ...
    public function fillAreablock(Page $page, string $field, int $seed = 1)
    {
    ...
    public function fillCheckbox(Page $page, string $field, int $seed = 1)
    {
    ...
    public function fillDate(Page $page, string $field, int $seed = 1)
    {
        $editable = new Date();
        $editable->setName($field);
    ...
    public function fillEmbed(Page $page, string $field, int $seed = 1)
    {
        $editable = new Embed();
        $editable->setName($field);
    ...
    public function fillImage(Page $page, string $field, int $seed = 1, array &$returnData)
    {
    ...
    public function fillInput(Page $page, string $field, int $seed = 1)
    {
        $editable = new Input();
        $editable->setName($field);
    ...
    public function fillLink(Page $page, string $field, int $seed = 1, &$returnData)
    {
    ...
    public function fillMultiselect(Page $page, string $field, int $seed = 1)
    {
    ...
    public function fillNumeric(Page $page, string $field, int $seed = 1)
    {
        $setter = 'set' . ucfirst($field);
    ...
    public function fillPdf(Page $page, string $field, int $seed = 1, array &$returnData)
    {
    ...
    public function fillRelation(Page $page, string $field, int $seed = 1, &$returnData)
    {
    ...
    public function fillRelations(Page $page, string $field, int $seed = 1, &$returnData)
    {
    ...
    public function fillScheduledblock(Page $page, string $field, int $seed = 1)
    {
    ...
    public function fillSelect(Page $page, string $field, int $seed = 1)
    {
        $setter = 'set' . ucfirst($field);
    ...
    public function fillTable(Page $page, string $field, int $seed = 1)
    {
        $editable = new Table();
        $editable->setName($field);
    ...
    public function fillVideo(Page $page, string $field, int $seed = 1, array &$returnData)
    {
    ...
    public function fillWysiwyg(Page $page, string $field, int $seed = 1)
    {
    ...
    public function fillTextarea(Page $page, string $field, int $seed = 1)
    {
    ...
    public function fillBlock(Page $page, string $field, int $seed = 1)
    {
        $editable = new Block();
        $editable->setName($field);
