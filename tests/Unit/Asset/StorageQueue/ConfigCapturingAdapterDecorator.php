...
/**
 * Records the Config every copy() receives, so a test can assert on what the processor
 * forwarded rather than on an observable side effect the local adapter does not have.
 */
final class ConfigCapturingAdapterDecorator implements FilesystemAdapter
{
    /**
     * @var list<array<string, mixed>>
     */
    public array $copyConfigs = [];
